    ...
    <div class="uk-width-3-4@l">
        <div class="uk-card">
            ...
            <div class="uk-card-body">
                    <form method="POST" id="form_advanced_validation" class="form-update-program" action="{{route('dashboard.kategori.update',['id'=>$data->id])}}" enctype="multipart/form-data">
                    {!! csrf_field() !!}
                
                    @include('dashboard.kategori.form_edit')
