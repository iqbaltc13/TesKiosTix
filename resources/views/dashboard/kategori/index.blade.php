        ...
        <div class="uk-width-auto@s">
            <div id="sc-dt-buttons">
                <div class="dt-buttons">
                    <a class="dt-button buttons-copy buttons-html5 sc-button" href="{{route('dashboard.kategori.create')}}" ><span data-uk-icon="icon: plus"></span> <span>Add Kategori</span></a>
    ...
    <div class="uk-card-body">
        ...
        <div id="modal-detail" data-uk-modal>
            <div class="uk-modal-dialog">
                ...
                <div class="uk-modal-body detail-kategori">
                    <table id="detail-kategori-table" class="uk-table uk-table-striped dt-responsive">
                        <tbody>
                            {{-- 
                            <tr>
                                <td></td>
        ...
        <div id="confirm-delete" data-uk-modal>
            <div class="uk-modal-dialog">
                <div class="uk-modal-header">
                    <h2 class="uk-modal-title">Confirm Delete Kategori</h2>
                </div>
                <div class="uk-modal-body delete-kategori">
...
<script>
    ...
    function modalDetail(id){
        let linkDetail = "{{route('dashboard.kategori.detail-json', ':id')}}";
    ...
    function modalDelete(id){
        let linkDelete = "{{route('dashboard.kategori.destroy', ':id')}}";
            ...
            "columns": [
                    ...
                    
                    {
                        ...
                        render: function(data){
                            let linkEdit = "{{route('dashboard.kategori.edit', ':id')}}";
